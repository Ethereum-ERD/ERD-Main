            ...
            <div className={s.indexes}>
                <div className={s.index}>
                    <div className={s.indexItem}>
                        <div className={s.indexName}>
                            TVL
                            <Popover title='' content={<div className={s.tipsModal}>The Total Value Locked (TVL) is the total value of Ether locked as collateral in the system, given in ETH and USD.</div>}>
                ...
                <div className={s.index}>
                    <div className={s.indexItem}>
                        <div className={s.indexName}>
                            Troves
                            <Popover title='' content={<div className={s.tipsModal}>The total number of active Troves in the system.</div>}>
                                <div className={s.help}>
                                    <CircleHelp />
                                </div>
                            </Popover>
                    ...
                    <div className={s.indexItem}>
                        <div className={s.indexName}>
                            ...
                            <Popover title='' content={<div className={s.tipsModal}>The total {stableCoinName} minted by the ERD Protocol.</div>}>
                                <div className={s.help}>
                                    <CircleHelp />
                                </div>
                            </Popover>
                ...
                <div className={s.index}>
                    <div className={s.indexItem}>
                        <div className={s.indexName}>
                            ...
                            <Popover title='' content={<div className={s.tipsModal}>The total {stableCoinName} currently held in the Stability Pool, expressed as an amount and a fraction of the {stableCoinName} supply.</div>}>
                                <div className={s.help}>
                                    <CircleHelp />
                                </div>
                            </Popover>
                    ...
                    <div className={s.indexItem}>
                        <div className={s.indexName}>
                            TCR
                            <Popover title='' content={<div className={s.tipsModal}>The ratio of the Dollar value of the entire system collateral at the current ETH:USD price, to the entire system debt.</div>}>
                                <div className={s.help}>
                                    <CircleHelp />
                                </div>
                            </Popover>
                ...
                <div className={s.index}>
                    <div className={s.indexItem}>
                        <div className={s.indexName}>
                            Recovery Mode
                            <Popover title='' content={<div className={s.tipsModal}>Recovery Mode is activated when the Total Collateral Ratio (TCR) falls below {(systemCCR * 100).toFixed(0)}%. When active, your Trove can be liquidated if its collateral ratio is below the TCR. The maximum collateral you can lose from liquidation is capped at {(systemMCR * 100).toFixed(0)}% of your Trove's debt. Operations are also restricted that would negatively impact the TCR.</div>}>
                                <div className={s.help}>
                                    <CircleHelp />
                                </div>
                            </Popover>
